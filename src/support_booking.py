...
def scrap_url(dest_id, checkin, checkout):
    ...
    # Get the proper URL
    url = f"https://www.booking.com/searchresults.es.html?lang=es&dest_id={dest_id}&dest_type=city&checkin={checkin}&checkout={checkout}&group_adults=1&no_rooms=1&group_children=0"
    driver.get(url)
